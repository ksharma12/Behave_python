...
def step_impl(context):
    ...
    while chapter <= 42:
        ...
        context.ele_ops.get_url("https://www.biblehub.com/job/"+chapter_str+"-"+verse_str+".htm")
        ...
        if context.ele_ops.get_element_text(oR.top_heading__XPATH) != "Bible Hub":
            ...
            mydoc = docx.Document("E://auto_frameworks//Behave_python//features//steps//job.docx")
            p = mydoc.add_paragraph()
            super_text = p.add_run(chapter_str + ":" + verse_str)
            super_text.font.superscript = True
            p.add_run([" " + ele + " " for ele in verse_text])
            mydoc.save("E://auto_frameworks//Behave_python//features//steps//job.docx")
