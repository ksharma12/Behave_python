...
class Element_Operations(Waits_Operations, Common_Operations, Driver_Operations):
    ...
    def find_element(self, locator_sig, locator):
        try:
            web_element = self.driver.find_element(locator_sig,
                                                   locator)
    ...
    def click(self, locator_sig, locator):
        flag = False
        try:
    ...
    def click_js(self, locator_sig, locator):
        flag = False
        try:
            ele = self.find_element(locator,locator_sig)
            self.highlight_element(ele)
    ...
    def select_by_value(self, locator_sig, locator, value):
        flag = False
        try:
    ...
    def move_to_element(self, locator_sig, locator):
        try:
            ele = self.find_element(locator_sig, locator)
            self.highlight_element(ele)
